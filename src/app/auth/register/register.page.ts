...
public getType() {
  ...
  submitForm() {
    this.isSubmitted = true;
      this.authService.register(this.ionicForm2.value['name'],this.ionicForm2.value['email'],this.ionicForm2.value['phone_number'],this.ionicForm2.value['password']).subscribe( data => {}, 
